...
export class ForwardingInstantiation extends Abstraction {
  ...
  constructor(
    ...
    this.registerProps__(propsToForward);
  }
   ...
   */
  registerProps__(props: Record<Prop, Partial<ForwardingPropertyDescriptor>>): void {
    /** props will be registered in {@link ./Abstraction.Abstraction} */
    super.registerProps__(ForwardingInstantiation.__transformPropertyDescriptors(props, this));
  }
...
> extends ForwardingInstantiation {
   ...
   */
  registerProps__(props: Record<string, Partial<ForwardingPropertyDescriptor>>): void {
    // super refers to {@link ForwardingInstantiation}
    super.registerProps__(DomForwardingInstantiation.__fillDefaultDescriptor(props));
  }
}
